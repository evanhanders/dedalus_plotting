...
To run and plot using e.g. 4 processes and plotpal scripts:
    ...
    $ mpiexec -n 4 python3 uniform_output_task.py
    $ mpiexec -n 4 python3 parallel_profile_operation.py 
"""
...
profiles.add_task(plane_avg(d3.div(d3.skew(u)) ** 2), name="enstrophy")
