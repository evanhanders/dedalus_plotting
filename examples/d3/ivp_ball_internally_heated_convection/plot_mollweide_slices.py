...
Usage:
    plot_mollweide_slices.py [options]
...
Options:
    ...
    --out_name=<str>         Name of figure output directory & base name of saved figures [default: snapshots_mollweide]
...
plotter.setup_grid(num_cols=2, num_rows=1, mollweide=True, **plotter_kwargs)
plotter.add_mollweide_colormesh(
